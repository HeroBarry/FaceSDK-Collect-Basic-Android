...
//    }
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            imageReader = ImageReader.newInstance(preferredWidth, preferredHeight, ImageFormat.YUV_420_888, 2);
...
//                    int rotation = 90;
                    ...
                    if (onFrameListener != null) {
                        onFrameListener.onPreviewFrame(data, rotation, image.getWidth(), image.getHeight());
                    }
                    image.close();
                }
            }, backgroundHandler);
    ...
    public int getCameraDisplayOrientation(Context context, int degrees,
